/*donor-reveal_v0.81
 ...
 Last updated 5.22.15, 10:50 a.m.
 */
require([
    'jquery',
    'lodash',
    ...
    function highlightText() {
        ...
        for (var i = 0; i < ncga_members.length; i++) {
            $.each($(".story-text").children(), function() {
                //skip embedded content and aside classes (secondary images)
                if ($(this).hasClass('embed-content') || $(this).is("aside")) {
                    return;
                }
 
                $(this).html(
                    $(this).html().replace(
                        ncga_members[i]["member"],
